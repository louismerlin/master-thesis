...
As per the Itanium C++ ABI, the base VTable of a class will contain an "offset-to-top", which will be 0 in the base VTable's case, followed by a pointer to an RTTI.
...
To check whether we have found an RTTI, we [TODO modifications in progress to simplify this] assert that the next value is a pointer to a string.
