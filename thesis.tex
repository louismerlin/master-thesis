...
Second, as a large (80M) and complex ELF file, it served as a perfect benchmark for the performance of the algorithm.
By adding a simple check earlier in the RTTI-spotting pipeline, we were able to speed up the analysis of the zoom binary 10 times.
See \autoref{zoomspeed} for the details of this benchmark.
...
\begin{table}[h]
  ...
  \begin{tabular}{l | r | r | r}
    ...
    \hline
    zoom 5.5.7938.0228 & 52m42.123s & 5m22.321s & $10\times$ \\ % THESE NUMBERS ARE FAKE AND WILL BE UPDATED SOON
    gold 1.16 & 0m5.123s & 0m1.321s & $5\times$ \\ % THESE NUMBERS ARE FAKE AND WILL BE UPDATED SOON
    ceph-dencoder 15.2.13 & 1m30.123s & 0m9.123s & $10\times$ % THESE NUMBERS ARE FAKE AND WILL BE UPDATED SOON
  \end{tabular}

\caption{Difference of computation time between algorithms on a machine running Ubuntu 20.04 with a 2.6 Ghz dedicated vCPU}
\label{zoomspeed}
