...
more details in \autoref{retrowriteimplementation}).
...
It contains information about what action to take if an exception is thrown in
a certain location.

The second table is the \emph{action table}. It contains offsets to next
actions (similarly to a linked list), and an index to the types table.
