...
Examples of well-known C++ projects include the zoom~\cite{zoom} conferencing software, the gold linker~\cite{gold} or \ant{Windows Explorer, Qt Framework, Chrome, Firefox, Some Embedded Projects. Very widely used :)} [TODO: find another "well-known" example].
