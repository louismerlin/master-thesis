...
\begin{table}[h]
  ...
  \begin{tabular}{r | l | r | r}
    Number of packages & Sorting criteria & Percentage of packages & Mean number of classes \\
...
\lou{TODO if we end up with a working version of C++ capabilities in RetroWrite}
