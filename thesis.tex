...
% symbols
Symbols are mainly used for shared object loading, to import the \textbf{cout}
object from \textbf{iostream} for example, the binary must be aware of an
object named \textbf{cout}.
