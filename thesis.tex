...
\dam{I am confused here: Your current addtions allow RetroWrite to work on \textbf{unstripped} C++ binaries? ...}
...
\dam{... and you detailed what will be needed to support \textbf{stripped} ones? Is my understanding correct? Maybe make this a bit more explicit.}
...
require more work and complexity to be translated to asm. \dam{What do you mean by "asm"? "assembly"?}
This also leads to important information being lost from C++ source code to 
binary, but also certain information remaining.
\dam{Maybe you could add examples of what remains and what not. To give an intuition/outlook about what you are talking.}
...
Several large projects, like the Zoom conferencing software \dam{Something seems to be missing here.}
...
an ELF file without worry. \dam{Maybe you want to be a bit more explicit here. PIC is used so that sharing of libraries by different processes works, right? Not really so that they can be inserted into ELF files.}
