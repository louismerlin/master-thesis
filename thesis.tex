...
Object Type Integrity is achived by making sure that the right virtual table is
...
Adding runtime checks during compliation allows for great coverage and low
overhead.
