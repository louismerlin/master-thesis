...
% to rewrite C++ binaries before, this could lead to very interesting discoveries;
...
DWARF.
Also, the EH\_FRAME is also used for going back on the stack for debugging 
purposes.}
...
say in your own words. Especially: about what we mean by symbolization in 
assembly, 
why we avoid heuristics for the moment (to be sure it works, also because 
shared 
