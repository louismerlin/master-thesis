...
\caption{Overview of an example of VTables and RTTI in memory with multiple inheritance}
\label{multipleinheritancegraph}

\end{figure}

\ant{I would potentially quote, or reword, parts of the cxx-abi here: what is in 
